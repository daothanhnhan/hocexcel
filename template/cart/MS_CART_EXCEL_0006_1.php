<?php
    ...
    // RANDOM MÃ CODE KÍCH HOẠT KHÓA HỌC
    ...
    $code_active_course = rand_string( 10 );
?>
<?php 
if (isset($_POST['send_mail'])){
    ...
    $code_active = $code_active_course;
    ...
    ";
    $cart->payment1($code_active);

    $mail = new action_email();
    $gui_mail = $mail->email_send($email, "Thông Tin Đặt Hàng Từ Học Excel 123",$content);
?>

    <script type="text/javascript">
        alert('Đặt hàng thành công. Mời bạn dùng mã đã được nhận để kích hoạt khóa học');
        window.location.href="/kich-hoat";
    </script>
<?php } ?>
                                                ...
                                                <div class="vk-checkout-order-paypal">
                                                    <div id="order_review" class="woocommerce-checkout-review-order">
                                                        ...
                                                        <div class="form-row place-order">
                                                            <button type="submit" name="send_mail" class="btn btn-primary" id="submitPayment" style="padding:10px 30px; font-weight:bold; font-size:16px; margin-bottom:15px;background-color:#2c944a; border:1px solid #fff;" ><?php if($lang == "vn"){echo "Hoàn tất mua hàng";}else{echo "Complete Shopping";}?></button>
