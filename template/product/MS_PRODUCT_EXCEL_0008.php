...
<div class="gb-khoahonoibat_excel">
    <div class="container">
        <div class="gb-khoahonoibat_excel-title">
            <h2>Khóa học excel khác</h2>
        </div>
        <div class="row">
            <?php
                $product = new action_product();
                $list_product = $product->getListProductHome_HasLimit(8);
        ...
        <div class="view-all text-center">
            <a href="/san-pham" title="" class="btn btn-success" role="button">Tất cả khóa học</a>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function (){
        $('.gb-khaohonoibat_excel-slide').owlCarousel({
            loop:true,
            margin:30,
            navSpeed:500,
            nav:false,
