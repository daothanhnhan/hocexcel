...
class action_menu extends library{
            ...
            foreach ($cate_child as $key => $item) {
                ...
                if($level == 0 && $row[$this->nameColTitle_menuLanguage] == "Trang chủ")
                  echo '<li>'; 
                    ...
                    if($level == 0 && $row[$this->nameColTitle_menuLanguage] != "Trang chủ")
                        echo '<li class="">'; 
                    if($level == 0 && $row[$this->nameColTitle_menuLanguage] == "Sản phẩm"){
    ...
    /*-----------------------------*/
    public function showMenu_byMultiLevel_mainMenuExcel($list_menu,$valParent_menu = 0,$lang, $level = 0){
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
    ...
    public function showMenu_byMultiLevel_mainMenuOnion_m($list_menu,$valParent_menu = 0,$lang, $level = 0){
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
        ...
        if ($cate_child) {    
            echo '<ul class="nav navbar-nav animated">';            
            foreach ($cate_child as $key => $item) {
                //if((($level+1) == 2)&($item[$this->nameColID_menu] == 94 )) echo '<div class="coverSubMenu">';
                $row = $this->getMenuLanguageDetail_byId($item[$this->nameColID_menu],$lang);
                $name = $row[$this->nameColTitle_menuLanguage];
    ...
    /*-----------------------------*/
    public function showMenu_byMultiLevel_mainMenuSTORE($list_menu,$valParent_menu = 0,$lang, $level = 0){
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
        ...
        if ($cate_child) {    
            ...
            foreach ($cate_child as $key => $item) {
                ...
                echo '<li>';
                echo '<a href="'.$url.'">'.$row[$this->nameColTitle_menuLanguage].'</a>';
                    $this->showMenu_byMultiLevel_mainMenuSTORE($list_menu,$item[$this->nameColID_menu],$lang, $level+1);              
                echo '</li>';            
            }
            echo '</ul>';        
        } 
    ...
    public function showMenu_byMultiLevel_mainMenuSTORE_m($list_menu,$valParent_menu = 0,$lang, $level = 0){
        $cate_child = array();
        foreach ($list_menu as $key => $item)
        {
            // Nếu là chuyên mục con thì hiển thị
        ...
        if ($cate_child) {    
            ...
            foreach ($cate_child as $key => $item) {
                ...
                echo '<li>'; 
                echo '<a href="'.$url.'">'.$row[$this->nameColTitle_menuLanguage].'</a>';
                    $this->showMenu_byMultiLevel_mainMenuSTORE_m($list_menu,$item[$this->nameColID_menu],$lang, $level+1);
                echo '</li>';            
            }
            echo '</ul>';        
        } 
