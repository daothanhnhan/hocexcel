...
<script>
    ...
    function deleteColor(val){
        ...
        if (confirm('Xóa màu khóa học, sẽ xóa tất cả kích cỡ của màu này')) {
                                    ...
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <div class="rowNCP">
                                            ...
                                            <div class="subColContent">
                                                ...
                                                <p class="titleRightNCP">Mã khóa học</p>
...
<form action="" method="post" enctype="multipart/form-data" id="updateProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Thông tin khóa học</span>

            <p class="subLeftNCP">Cung cấp thông tin về tên, mô tả loại khóa học và nhà sản xuất để phân loại khóa học</p>   

            <p class="titleRightNCP">Chọn ảnh đại diện cho khóa học</p>
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Tên khóa học</p>
           ...
           <!--  <p class="titleRightNCP">Danh mục</p>
            ...
            <p class="titleRightNCP">Giảng viên</p>
            <select name="teacher_id" class="txtNCP1">
                <!-- <option value="0">Chon ...</option> -->
                <?php foreach ($list_teacher as $item) { ?>
                <option value="<?= $item['id'] ?>" <?= ($item['id']==$row['teacher_id']) ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                <?php } ?>
            </select>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Ảnh phụ khóa học</span>

            <p class="subLeftNCP">Thiết lập ảnh phụ cho khóa học</p>

        </div>

        <div class="boxNodeContentPage">

            <h3>Ảnh phụ khóa học</h3>
    ...
    <div class="rowNodeContentPage">
        ...
        <!-- <div class="leftNCP">
            ...
            <span class="titLeftNCP">Ảnh khóa học</span>

            <p class="subLeftNCP">Thiết lập ảnh khóa học</p>
    ...
    <div class="rowNodeContentPage">
        ...
        <!-- <div class="leftNCP">
            ...
            <p class="subLeftNCP">Bạn có thể cấu hình và quản lý kho cho từng loại của khóa học này</p>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Quản lý và tùy chọn</span>

            <p class="subLeftNCP">Bạn có thể cấu hình và quản lý cho từng loại của khóa học này</p>
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <p class="titleRightNCP">Số bài học</p>
                ...
                <div class="subColContent" >
                    ...
                    <p class="titleRightNCP">Bài viết của giảng viên</p>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <p class="titleRightNCP">Quản lý bài học</p>

                    <p class="titleRightNCP"><a role="button" class="btn btn-danger" href="/admin/?page=mau-san-pham&id=<?= $product_id ?>">Quản lý bài học</a></p>
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_new" <?= $row['product_new'] == 1 ? 'checked' : '' ?>>khóa học mới
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_hot" <?= $row['product_hot'] == 1 ? 'checked' : '' ?>>khóa học hot
