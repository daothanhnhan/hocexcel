...
<form action="" method="post" accept-charset="utf-8" id="updateProductCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="productcat_new" <?= $row['productcat_new'] == 1 ? 'checked' : '' ?>>Khóa học mới
                </label>
            </div>
            <div>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="productcat_hot" <?= $row['productcat_hot'] == 1 ? 'checked' : '' ?>>Khóa học nổi bật
                </label>
            </div>
        </div>
    </div><!--end rowNodeContentPage-->
