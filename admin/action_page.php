...
class action_page extends library{
	...
	/*--------------- Danh mục sản phẩm -------------------*/
		...
		public function updateProductCat(){
			...
			$productcat_hot = isset($_POST['productcat_hot']) ? $_POST['productcat_hot'] : '';

			$productcat_new = isset($_POST['productcat_new']) ? $_POST['productcat_new'] : '';
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiissssssssssssssssiissssi');
