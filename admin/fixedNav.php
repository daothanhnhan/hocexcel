        ...
        <ul class="listMenuFL">
          ...
          <!--  <li><a href="index.php?page=danh-muc-dich-vu" title=""
           ...
           <!--  <li><a href="index.php?page=dich-vu" title=""
            ...
            <li><a href="index.php?page=danh-muc-san-pham" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'danh-muc-san-pham' || $_GET["page"] == 'them-danh-muc-san-pham' || $_GET["page"] == 'sua-danh-muc-san-pham') {
                       echo 'sltMenu';
                                                                               ...
                                                                               class="iconMenu"/>Danh mục khóa học</a>
            </li>
            ...
            <li><a href="index.php?page=san-pham" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'san-pham' || $_GET["page"] == 'them-san-pham' || $_GET["page"] == 'sua-san-pham') {
                       echo 'sltMenu';
                                                                               ...
                                                                               class="iconMenu"/>Danh sách khóa học</a></li>
            ...
            <li><a href="index.php?page=giang-vien" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Giảng viên</a>
            </li>

            <li><a href="index.php?page=comment" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Comment</a>
            </li>
