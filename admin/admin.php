        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ////////Quản lý bài học/////////
                    case "them-mau":
                        include_once("template/mau-san-pham/add.php");
                        break;

                    case "sua-mau":
                        include_once("template/mau-san-pham/edit.php");
                        break;

                    case "xoa-mau":
                        include_once("template/mau-san-pham/del.php");
                        break;

                    case "mau-san-pham":
                        include_once("template/mau-san-pham/list.php");
                        break;

                    ///////////// giảng viên //////////////
                    case "giang-vien":
                        include_once("template/giang-vien/giang-vien.php");
                        break;

                    case "them-giang-vien":
                        include_once("template/giang-vien/them-giang-vien.php");
                        break;

                    case "sua-giang-vien":
                        include_once("template/giang-vien/sua-giang-vien.php");
                        break;

                    case "xoa-giang-vien":
                        include_once("template/giang-vien/xoa-giang-vien.php");
                        break;
                        
                    ///////////// comment /////////////////
                    case "comment":
                        include_once("template/comment.php");
                        break;
                    ///////////// Default /////////////////
                    default:
